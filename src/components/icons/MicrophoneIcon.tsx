...
const MicrophoneIcon = ({ color } : { color?: string }) => {
    return (
        <svg
            ...
            <path
                fill={color || "#292D32"}
                d="M12 22.75c-5.38 0-9.75-4.37-9.75-9.75v-2c0-.41.34-.75.75-.75s.75.34.75.75v2c0 4.55 3.7 8.25 8.25 8.25s8.25-3.7 8.25-8.25v-2c0-.41.34-.75.75-.75s.75.34.75.75v2c0 5.38-4.37 9.75-9.75 9.75zM14.61 8.23c-.08 0-.17-.01-.26-.04a7.373 7.373 0 00-4.99 0 .742.742 0 01-.95-.45.75.75 0 01.45-.96c1.94-.7 4.07-.7 6.01 0 .39.14.59.57.45.96-.11.31-.4.49-.71.49z"
            ></path>
            <path
                fill={color || "#292D32"}
                d="M13.7 11.23c-.06 0-.13-.01-.2-.03-1.07-.29-2.2-.29-3.27 0a.75.75 0 11-.39-1.45c1.33-.36 2.73-.36 4.06 0a.754.754 0 01-.2 1.48z"
            ></path>
        </svg>
    )
}
