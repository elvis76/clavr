...
const VideoIcon = ({ color } : { color?: string }) => {
    return (
        <svg
            ...
            <path
                fill={color || "#292D32"}
                d="M20.78 18.11c-.43 0-.98-.14-1.61-.58l-2.67-1.87a.754.754 0 01-.32-.62V8.96c0-.25.12-.48.32-.62l2.67-1.87c1.19-.83 2.06-.59 2.47-.38.41.22 1.11.79 1.11 2.24v7.33c0 1.45-.7 2.03-1.11 2.24-.19.11-.49.21-.86.21zm-3.09-3.47l2.35 1.64c.45.31.77.34.9.27.14-.07.29-.35.29-.89V8.34c0-.55-.16-.82-.29-.89-.13-.07-.45-.04-.9.27l-2.35 1.64v5.28zM11.5 11.75c-1.24 0-2.25-1.01-2.25-2.25s1.01-2.25 2.25-2.25 2.25 1.01 2.25 2.25-1.01 2.25-2.25 2.25zm0-3c-.41 0-.75.34-.75.75s.34.75.75.75.75-.34.75-.75-.34-.75-.75-.75z"
            ></path>
        </svg>
    )
}
